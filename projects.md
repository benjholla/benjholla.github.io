...
- [Immutability Toolbox](https://github.com/EnSoftCorp/immutability-toolbox) - A toolbox for object immutability analysis and method purity (side effect analysis).
